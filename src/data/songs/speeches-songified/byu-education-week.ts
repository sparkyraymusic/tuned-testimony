...
export const byuEducationWeekSongs: Song[] = [
  {
    slug: "patrick-kearon-peace-and-rest-even-now",
    title: "Peace and Rest—Even Now (Speeches Songified)",
    collection: "Speeches Songified",
    releaseType: "Single",
    style: "Speech Song",
    speechSpeaker: "Patrick Kearon",
    speechForum: "BYU Education Week",
    ...
    links: [
      { name: "Cinematic Video", url: "https://youtu.be/2ZE9QT_vizY" },
      { name: "Talk", url: "https://speeches.byu.edu/talks/patrick-kearon/peace-and-rest-even-now/" },
    ],
  },
];
