...
export const april2026ConferenceSongs: Song[] = [
  conferenceSong({
    ...
    sessionOrder: 1,
    talkOrder: 1,
    image: "/songs/conference/2026/april/patrick-kearon-about-his-business.webp",
  ...
  conferenceSong({
    ...
    sessionOrder: 1,
    talkOrder: 2,
    image: "/songs/conference/2026/april/kristin-m-yee-ministering-that-ye-love-one-another.webp",
  ...
  conferenceSong({
    ...
    sessionOrder: 1,
    talkOrder: 3,
    image: "/songs/conference/2026/april/clark-g-gilbert-come-home.webp",
  ...
  conferenceSong({
    ...
    sessionOrder: 1,
    talkOrder: 4,
    image: "/songs/conference/2026/april/david-a-bednar-all-who-have-endured-valiantly.webp",
  ...
  conferenceSong({
    ...
    sessionOrder: 1,
    talkOrder: 5,
    image: "/songs/conference/2026/april/michael-john-u-teh-follow-the-prophet-he-knows-the-way.webp",
  ...
  conferenceSong({
    ...
    sessionOrder: 1,
    talkOrder: 6,
	image: "/songs/conference/2026/april/jose-a-becerra-tithing-putting-god-first.webp",
  ...
  conferenceSong({
    ...
    sessionOrder: 1,
    talkOrder: 7,
    image: "/songs/conference/2026/april/henry-b-eyring-prayers-for-peace.webp",
	...
	conferenceSong({
		...
		sessionOrder: 2,
		talkOrder: 8,
		image: "/songs/conference/2026/april/gary-e-stevenson-lost-luggage-redeemed-souls.webp",
	...
	conferenceSong({
		...
		sessionOrder: 2,
		talkOrder: 9,
		image: "/songs/conference/2026/april/eduardo-f-ortega-christ-author-and-finisher-of-our-faith.webp",
	...
	conferenceSong({
		...
		sessionOrder: 2,
		talkOrder: 10,
		image: "/songs/conference/2026/april/wan-liang-wu-i-will-give-away-all-my-sins-to-know-thee.webp",
	...
	conferenceSong({
		...
		sessionOrder: 2,
		talkOrder: 11,
		image: "/songs/conference/2026/april/david-j-wunderli-jesus-christ-is-not-our-burden.webp",
	...
	conferenceSong({
		...
		sessionOrder: 2,
		talkOrder: 12,
		image: "/songs/conference/2026/april/gerald-causse-love-all-love-each.webp",
	...
	conferenceSong({
		...
		sessionOrder: 2,
		talkOrder: 13,
		image: "/songs/conference/2026/april/brian-j-holmes-jesus-christ-is-the-way.webp",
	...
	conferenceSong({
		...
		sessionOrder: 2,
		talkOrder: 14,
		image: "/songs/conference/2026/april/clement-m-matswagothata-he-knows-you-by-name.webp",
	...
	conferenceSong({
		...
		sessionOrder: 2,
		talkOrder: 15,
		image: "/songs/conference/2026/april/ulisses-soares-jesus-christ-the-true-vine.webp",
	...
	conferenceSong({
		...
		sessionOrder: 3,
		talkOrder: 16,
		image: "/songs/conference/2026/april/dieter-f-uchtdorf-encounter-at-the-empty-tomb.webp",
	...
	conferenceSong({
		...
		sessionOrder: 3,
		talkOrder: 17,
		image: "/songs/conference/2026/april/emily-belle-freeman-best-days-and-worst-days.webp",
	...
	conferenceSong({
		...
		sessionOrder: 3,
		talkOrder: 18,
		image: "/songs/conference/2026/april/pedro-x-larreal-i-feel-my-saviors-love.webp",
	...
	conferenceSong({
		...
		sessionOrder: 3,
		talkOrder: 19,
		image: "/songs/conference/2026/april/edward-b-rowe-choose-jesus-christ-as-your-guide.webp",
	...
	conferenceSong({
		...
		sessionOrder: 3,
		talkOrder: 20,
		image: "/songs/conference/2026/april/ronald-a-rasband-he-is-risen.webp",
	...
	conferenceSong({
		...
		sessionOrder: 3,
		talkOrder: 21,
		image: "/songs/conference/2026/april/dale-g-renlund-because-of-jesus-christ.webp",
	...
	conferenceSong({
		...
		sessionOrder: 3,
		talkOrder: 22,
		image: "/songs/conference/2026/april/thierry-k-mutombo-the-joy-of-a-covenant-relationship-with-god.webp",
	...
	conferenceSong({
		...
		sessionOrder: 3,
		talkOrder: 23,
		image: "/songs/conference/2026/april/alan-r-walker-a-peculiar-treasure.webp",
	...
	conferenceSong({
		...
		sessionOrder: 3,
		talkOrder: 24,
		image: "/songs/conference/2026/april/dallin-h-oaks-alive-in-christ.webp",
	...
	conferenceSong({
		...
		sessionOrder: 4,
		talkOrder: 25,
		image: "/songs/conference/2026/april/d-todd-christofferson-the-character-of-christ.webp",
	...
	conferenceSong({
		...
		sessionOrder: 4,
		talkOrder: 26,
		image: "/songs/conference/2026/april/chi-hong-sam-wong-remember-remember.webp",
	...
	conferenceSong({
		...
		sessionOrder: 4,
		talkOrder: 27,
		image: "/songs/conference/2026/april/aaron-t-hall-i-glory-in-my-jesus.webp",
	...
	conferenceSong({
		...
		sessionOrder: 4,
		talkOrder: 28,
		image: "/songs/conference/2026/april/susan-h-porter-here-am-i-send-me.webp",
	...
	conferenceSong({
		...
		sessionOrder: 4,
		talkOrder: 29,
		image: "/songs/conference/2026/april/neil-l-andersen-eternal-marriage-is-an-eternal-journey.webp",
	...
	conferenceSong({
		...
		sessionOrder: 4,
		talkOrder: 30,
		image: "/songs/conference/2026/april/quentin-l-cook-keys-covenants-and-easter.webp",
	...
	conferenceSong({
		...
		sessionOrder: 4,
		talkOrder: 31,
		image: "/songs/conference/2026/april/taniela-b-wakolo-come-unto-christ-together.webp",
	...
	conferenceSong({
		...
		sessionOrder: 4,
		talkOrder: 32,
		image: "/songs/conference/2026/april/gerrit-w-gong-tis-eastertide-no-one-walks-alone.webp",
	...
	conferenceSong({
		...
		sessionOrder: 4,
		talkOrder: 33,
		image: "/songs/conference/2026/april/dallin-h-oaks-closing-remarks-jesus-is-the-way.webp",
