...
export const april1976ConferenceSongs: Song[] = [
  {
    slug: "ezra-taft-benson-the-constitution-a-glorious-standard",
    title: "The Constitution: A Glorious Standard",
    collection: "Conference",
    releaseType: "Single",
    style: "Conference Talk Song",
    image: "/songs/conference/1976/april/ezra-taft-benson-the-constitution-a-glorious-standard.webp",
    conferenceYear: 1976,
    ...
    links: [
      ...
      { name: "Amazon Music", url: "https://music.amazon.com/albums/B0H424C6GS?marketplaceId=ATVPDKIKX0DER&musicTerritory=US&ref=dm_sh_tWQBlGmtpkcnA2cc79927ZBNS&trackAsin=B0H426PB7L" },
      { name: "Lyric Video", url: "https://youtu.be/zDZWFf0j2Mo" },
    ],
  },
];
